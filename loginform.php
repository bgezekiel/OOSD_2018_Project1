<?php
/*customer login form, checks if the session is set and customer is valied then redirected to 
welcome page, otherwise shows customer to provide login to start the session*/
session_start();
...
<html lang="en">
 ...
 <div class="container">
    ...
    <h6 class="card-subtitle mb-2 text-muted">Please provide Sign Info.</h6>
